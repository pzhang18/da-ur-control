...
# Load the ONNX model
model_path = "C:/Users/pengf/rl/RTDE_Python_Client_Library/examples/TCP23SAC.onnx"
...
obs_rotation_v3 = [0.00020356, -0.00044415,  0.00088845] # vector3
...
# convert XYZ rotation to Unity's quaterion coordinate. 
obs_rotation = Rotation.from_euler('xyz', obs_rotation_v3, degrees=False).as_quat().tolist()
# concatenate all observation into an input tensor
input_data = np.array((obs_target_pos + obs_position + obs_rotation
